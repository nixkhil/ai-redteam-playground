# 🧪 AI Red Team Labs  
**An Interactive Prompt-Attack, Escalation, and Defense Evaluation Playground**

---

## Overview

**AI Red Team Labs** is an interactive, experiment-driven lab designed to systematically probe, refine, and pressure-test Large Language Models (LLMs) using real red-team methodologies.
...
- Full-screen background (1920×1080 recommended)
- Dark translucent “glass” UI
- High-contrast text for long sessions
- Cursor styling fixed for readability

---

## Folder Structure

ai-redteam-playground/
├── app.py
├── attacks/
│ └── attacks.json
└── assets/
...
- Supported model (default: `mistral:instruct`)
